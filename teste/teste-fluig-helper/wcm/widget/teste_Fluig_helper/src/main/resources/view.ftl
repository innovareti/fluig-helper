<div id="TesteFluigHelper_${instanceId}" class="super-widget wcm-widget-class fluig-style-guide" data-params="TesteFluigHelper.instance()">
    ...
    <div id="content">
        ...
        <div class="table-responsive fs-xl-margin-top">
            <table class="table" id="table_TesteFluigHelper_${instanceId}">
                <thead>
                    <tr>
                        <th>SEQUÊNCIA</th>
                        <th>ID</th>
