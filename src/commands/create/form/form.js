const command = {
    name: 'form',
    description: "Cria um formulário simples",
    run: async toolbox => {
        const {
            parameters,
            template,
        ...
        if (runCode || !!parameters.options.r === true) {
            await template.generate({
                template: "forms/form/index.html.ejs",
        ...
        if (runCode || !!parameters.options.r === true) {
            await template.generate({
                template: "forms/form/main.js.ejs",
        ...
        if (runCode || !!parameters.options.r === true) {
            await template.generate({
                template: "forms/form/style.css.ejs",
        ...
        if (runCode || !!parameters.options.r === true) {
            await template.generate({
                template: "forms/form/events/displayFields.ejs",
